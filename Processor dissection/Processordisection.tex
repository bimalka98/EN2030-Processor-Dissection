...
\pagebreak
 ...
 \begin{figure}[!h]
	\centering
	\subfigure[Quad Core - Corei3-8300 Processor]
...
\end{figure}
 ...
 \begin{figure}[!h]
	...
	{ \includegraphics[scale=0.28, angle= +90]{figures/r5processor}
			\label{r5processor}
	}\hfill
	\subfigure[A Single CPU]
	{ \includegraphics[scale=0.51]{figures/r5core}
	\label{r5core}
	}
...
\subsection{Intel Core i3-8300 Processor}%MAHAWELA P.D
%18.7 COUNTING CLOCKS
\subsection{Arm Cortex-R5 Processor} % RAVINDU NAGASINGHE
